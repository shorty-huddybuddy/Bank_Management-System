...
public class SignUpWindow extends JFrame implements ActionListener {
	...
	public SignUpWindow() {
		...
		accountType.addItem("Credit Account");
		accountType.addItem("Loan Account");
		jp.add(accountType);
		...
		// jp6.add(new JLabel("PAN Card Number: "));
		// jp6.add(NID);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("Back")) {
			...
			if (isFormFilled()) {
				...
				JOptionPane.showMessageDialog(null, "Please fill up all the fields", "Failed",
	...
	void createNewAccount() {
		...
		// 		sex, d);
		UserInformation u = new UserInformation(firstNameT.getText(), lastNameT.getText());
		...
		JOptionPane.showMessageDialog(null, "Account Number:" + ac.getAccuntNo() + "\nPIN:" + ac.getPIN(), "Success",
